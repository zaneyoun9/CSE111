...
def main():
    ...
    chemical_formula = input('What formula is being used? ')
    ...
    print(f'The number of moles in the sample: {moles:.5f}')

# creates a period table dictionary and returns it
...
def compute_molar_mass(symbol_quantity_list, periodic_table_dict):
    ...
    1.00794 * 2 + 15.9994 * 1
    18.01528
    6.022 * 10**23 moles= mass / molar_mass
    """
    ...
    for molecule in symbol_quantity_list:
        molar_mass += (periodic_table_dict.get(molecule[NAME_INDEX])[ATOMIC_MASS_INDEX] * molecule[QUANTITY_INDEX])
